/*jslint browser: true*/
/*global $id, cssobjects, document, window, wpt_change_selected, wpt_device_specific, wpt_fullscreen, wpt_init, wpt_init_fd_slider, wpt_init_select, wpt_setButton, wpt_set_device_type, wpt_shift_key_status, wpt_save_items_height, wpt_collapse_all, wpt_fold_toggle, wpt_keyset, wpt_keyrelease, insert_sm, loadCSSexample, ptr_init, fdSlider*/
...
function wpt_init_fd_slider() {
    "use strict";
    var animation, maxvalue, minvalue, mstep, i = 0, fd_slider = [],
...
function wpt_init_select() {
    "use strict";
    var inputbox, selected, select_eles, select_element, x, y,
...
function wpt_collapse_all() {
    "use strict";
    var menu_items = document.getElementsByClassName('wpt_contents'), i,
        menu_item, menu_item_height;
...
function wpt_expand_all() {
    "use strict";
    var pre_shift_key_status = wpt_shift_key_status, i;
...
function wpt_save_items_height() {
    "use strict";
    var menu_items = document.getElementsByClassName('wpt_contents');
    var menu_item, menu_item_height, i, prev_item;
    for (i = 0; i < menu_items.length; i += 1) {
        menu_item = menu_items[i];
