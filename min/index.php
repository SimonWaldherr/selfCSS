...
<div class="button" id="foldin_btn" onclick="wpt_fold_all_in();">fold all in</div>
<div class="button" id="foldout_btn" onclick="wpt_fold_all_out();">fold all out</div>
...
<div id="sidebar"> <div class="header">Main</div>
<div class="item"><div class="title" id="Main-Position">Position</div>
<div class="wpt_contents"> <div id="posonoff" class="segmented segtwo"><div class="segment selected">off</div><div class="segment">on</div>
</div>
<div id="postype1" class="segmented segthree"><div class="segment selected">relative</div><div class="segment">absolute</div><div class="segment">fixed</div>
</div>
<div id="postype2" class="segmented segthree"><div class="segment selected">px</div><div class="segment">em</div><div class="segment">%</div>
</div>
...
<div class="wpt_contents"> <div id="sizeonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="sizetype" class="segmented segthree"><div class="segment selected">px</div><div class="segment">em</div><div class="segment">%</div>
</div>
...
<div class="wpt_contents"> <div id="padonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="paddd" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="margonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="margd" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="disponoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="displayt" class="segmented full"><div class="segment full selected">block</div><div class="segment full">inline</div><div class="segment full">inline-block</div><div class="segment full">inline-table</div><div class="segment full">none</div>
</div>
</div>
</div>
<div class="header">Background</div>
<div class="item"><div class="title" id="Background-Color">Color</div>
<div class="wpt_contents"> <div id="bgonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="bgd" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="backgroundimg" class="segmented full"><div class="segment full selected">none</div><div class="segment full">summer</div><div class="segment full">winter</div>
</div>
</div>
</div>
<div class="item"><div class="title" id="Background-Size">Size</div>
<div class="wpt_contents"> <div id="bgstype" class="segmented segtwo"><div class="segment selected">px</div><div class="segment">%</div>
</div>
...
<div class="wpt_contents"> <div id="bgptype" class="segmented segtwo"><div class="segment selected">px</div><div class="segment">%</div>
</div>
...
<div class="wpt_contents"> <div id="fsizeonoff" class="segmented segtwo"><div class="segment selected">off</div><div class="segment">on</div>
</div>
<div id="fontsizetype" class="segmented segfour"><div class="segment selected">px</div><div class="segment">em</div><div class="segment">pt</div><div class="segment">%</div>
</div>
...
<div class="wpt_contents"> <div id="tconoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
 <table> <tbody> <tr> <td>Red:</td> <td> <input name="tcred" id="tcred" class="fd_slider" type="range" max="255" min="0" title="tcred" value="0" maxlength="6" /> </td> </tr> <tr> <td>Green:</td> <td> <input name="tcgreen" id="tcgreen" class="fd_slider" type="range" max="255" min="0" title="tcgreen" value="0" maxlength="6" /> </td> </tr> <tr> <td>Blue:</td> <td> <input name="tcblue" id="tcblue" class="fd_slider" type="range" max="255" min="0" title="tcblue" value="0" maxlength="6" /> </td> </tr> </tbody> </table> </div>
</div>
<div class="item"><div class="title" id="Main-Font">Font</div>
<div class="wpt_contents"> <div id="fontonoff" class="segmented segtwo"><div class="segment selected">off</div><div class="segment">on</div>
</div>
<div id="font" class="segmented full"><div class="segment full selected">Helvetica</div><div class="segment full">Lucida</div><div class="segment full">Georgia</div><div class="segment full">Menlo</div><div class="segment full">Hoefler</div>
</div>
</div>
</div>
<div class="header">Border</div>
<div class="item"><div class="title" id="Border-Thickness">Thickness</div>
<div class="wpt_contents"> <div id="btonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="bordert" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <table> <tbody> <tr> <td>Red:</td> <td> <input name="bcred" id="bcred" class="fd_slider" type="range" max="255" min="0" title="bcred" value="255" maxlength="6" /> </td> </tr> <tr> <td>Green:</td> <td> <input name="bcgreen" id="bcgreen" class="fd_slider" type="range" max="255" min="0" title="bcgreen" value="255" maxlength="6" /> </td> </tr> <tr> <td>Blue:</td> <td> <input name="bcblue" id="bcblue" class="fd_slider" type="range" max="255" min="0" title="bcblue" value="255" maxlength="6" /> </td> </tr> </tbody> </table> </div>
</div>
<div class="item"><div class="title" id="Border-Type">Type</div>
<div class="wpt_contents"> <div id="btype" class="segmented full"><div class="segment full selected">solid</div><div class="segment full">dotted</div><div class="segment full">dashed</div><div class="segment full">double</div><div class="segment full">none</div>
</div>
</div>
</div>
<div class="item"><div class="title" id="Border-Radius">Radius</div>
<div class="wpt_contents"> <div id="bradonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="borderd" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="bsonoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
<div id="bstype" class="segmented segtwo"><div class="segment selected">inset</div><div class="segment">outside</div>
</div>
...
<div class="wpt_contents"> <div id="bscold" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="tsonoff" class="segmented segtwo"><div class="segment selected">off</div><div class="segment">on</div>
</div>
...
<div class="wpt_contents"> <div id="tscold" class="segmented segtwo"><div class="segment selected">different</div><div class="segment">same</div>
</div>
...
<div class="wpt_contents"> <div id="filteronoff" class="segmented segtwo"><div class="segment">off</div><div class="segment selected">on</div>
</div>
...
<div id="demo_div"><div class="selfCSS"></div>
</div>
<div id="demo_imgs"><div class="selfCSS" style="background-image:url(./summer.jpg);"></div>
</div>
<div id="demo_imgw"><div class="selfCSS" style="background-image:url(./winter.jpg);"></div>
</div>
</div>
</div>
...
<br/><br/> <div class="button closedialog" onclick="wpt_dialog();">Close</div>
</div>
...
<div id="onSmartphones">selfCSS does not work on Smartphones, please try it on the iPad or on a PC</div>
 <script type="text/javascript"> var _gaq = _gaq || []; _gaq.push(['_setAccount', 'UA-36066376-1']); _gaq.push(['_setDomainName', 'selfcss.org']); _gaq.push(['_trackPageview']); (function() { var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true; ga.src = 'http://statistik.simon.waldherr.eu/ga.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s); })(); </script> </body> </html> 